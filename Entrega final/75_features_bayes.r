...
# --/ Obtenemos solo el 75% de las caracteristicas del archivo selected_features_75.txt
features <- scan("Entrega final/selected_features_75.txt", what = character())
...
dataset_75 <- dataset_clf[, selected_features_75]

# --/ Agregamos la columna clase
dataset_75["NObeyesdad"] <- dataset_clf[, class_column]

dataset_clf <- dataset_75
